...
#[derive(Debug)]
pub struct SynthCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SynthCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SynthCore processing");
    
    let mut processor = SynthCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SynthCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SynthCoreProcessor::new(false);
